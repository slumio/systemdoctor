...
std::vector<std::string> list_directory(const std::string& path, bool recursive = true);

// Subprocess helpers
std::string run_command_output(const std::string& cmd, int* exit_code = nullptr);
